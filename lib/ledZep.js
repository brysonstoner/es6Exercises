...
var LedZepSong = function (_Song) {
  ...
  function LedZepSong(title) {
    ...
    return _possibleConstructorReturn(this, (LedZepSong.__proto__ || Object.getPrototypeOf(LedZepSong)).call(this, "Led Zeppelin", title)); //in this file, Led Zeppelin is the only band
  }
